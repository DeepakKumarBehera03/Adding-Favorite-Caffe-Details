...
class CafeForm(FlaskForm):
    ...
    open = StringField("open time ex : 8.00 AM", [validators.InputRequired()])
    close = StringField("Close time ex : 8.00 PM", [validators.InputRequired()])
    location = StringField("Cafe Location on Google Maps (URL)", [validators.InputRequired()])
